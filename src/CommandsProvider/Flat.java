...
public class Flat implements Serializable, Comparable<Flat> {
    ...
    public Flat(int id, String name, Coordinates coordinates, Date creationDate, Long area, long numberOfRooms, Furnish furnish, View view, Transport transport, House house) {
        this.id = id;
        this.name = name;
